...
export class Snake extends AcGameObject {
    constructor(info, gamemap) {
        ...
        this.cells = [new Cell(info.r, info.c)];  // cells[0] is head

        this.speed = 2;  // go speed cells per second
        this.direction = -1;  // -1: default, 0-3:up,right,down,left
        this.status = "idle";  // idle, move, die
        this.next_cell = null;  // target cell

        this.dr = [-1, 0, 1, 0];
        this.dc = [0, 1, 0, -1];

        this.step = 0;  // num of round
        this.eps = 1e-2;
