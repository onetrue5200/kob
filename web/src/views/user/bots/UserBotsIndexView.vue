            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px">
                    <div class="card-header">
                        <span style="font-size: 150%">我的Bots</span>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <VAceEditor v-model:value="botadd.content" class="form-control"
                                                id="add-bot-code" rows="10" @init="editorInit" lang="c_cpp"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <VAceEditor v-model:value="bot.content" class="form-control"
                                                                rows="10" @init="editorInit" lang="c_cpp"
                                                                theme="textmate" style="height: 300px" />
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
